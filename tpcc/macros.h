...
#define ALIGN_MEM alignas(CACHELINE_SIZE)
#define ALIGN_PTR(arr, n_entry, type) posix_memalign(reinterpret_cast<void**>(&arr), CACHELINE_SIZE, n_entry * sizeof(type));
