...
public:
  ...
  virtual bool get(
      ...
      std::string &value,
      size_t max_bytes_read = std::string::npos, uint32_t acc_id = 0) = 0;
  
  virtual void set_table_order(
  ...
  virtual bool get_for_read(
      void *txn,
      const std::string &key,
      std::string &value,
      size_t max_bytes_read = std::string::npos, uint32_t acc_id = 0) { return false;}
  ...
  put(void *txn,
      const std::string &key,
      const std::string &value, uint32_t acc_id = 0) = 0;

  virtual const char *
  put(void *txn,
      std::string &&key,
      std::string &&value, uint32_t acc_id = 0)
  {
    return put(txn, static_cast<const std::string &>(key),
                    static_cast<const std::string &>(value), acc_id);
  }
  ...
  insert(void *txn,
         const std::string &key,
         const std::string &value, uint32_t acc_id = 0)
  {
  ...
  virtual void remove(
      void *txn,
      const std::string &key, uint32_t acc_id = 0)
  {
    put(txn, key, "", acc_id);
  }
  ...
  virtual void remove(
      void *txn,
      std::string &&key, uint32_t acc_id = 0)
  {
