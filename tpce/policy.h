...
#elif WORKLOAD_TYPE == WL_TPCE
#define TXN_TYPE 4
#define ACCESSES 105
const uint32_t txn_access_num[] = { 0 /*just a placeholder*/, 30, 48, 10, 17};
const uint32_t base_access_num[] = {0, 0, 30, 78, 88};
const int32_t encoder_feature_cap[ENCODER_N_FEATURES] = {1, 5, 105, 16, 16, 16};
#endif
